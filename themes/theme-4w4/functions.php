...
/*
Permet d'activer le «Custom Header» permettant d'ajouter une image dans l'entête.
À partir du Customiser
*/
...
/*
 ...
 function themename_custom_header_setup() {
    $args = array(
        'default-image'      => get_template_directory_uri() . '/img/entete.png',
